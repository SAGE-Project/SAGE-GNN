...
class Wrapper_GNN_Z3:
    ...
    def __init__(self, model_path="../Models/GNNs/Oryx2/Oryx2-ModelRGCN1000Samples30Epochs.pth", symmetry_breaker="FVPR"):
    ...
    def solve(self, application_model_json, offers_json, mode="gnn"):
        ...
        if mode == "gnn":
            ...
            solution = z3_solver.solve(application_model_json, offers_json, out=True)
