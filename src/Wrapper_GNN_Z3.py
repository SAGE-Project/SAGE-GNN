...
class Wrapper_GNN_Z3:
    def __init__(self, model_path="/Users/madalinaerascu/PycharmProjects/SAGE-GNN/Models/GNNs/SecureWebContainer/1-hidden-layer/CrossEntropyLoss-aggreg-sum/model_RGCN_1000_samples_100_epochs_32_batchsize.pth", symmetry_breaker="None"):
