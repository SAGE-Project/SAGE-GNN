...
def extract_parameters(filename):
    ...
    rgcn_pattern = (
        r"Wordpress7_RGCN_(?P<samples>\d+)_samples_(?P<epochs>\d+)_epochs_(?P<batchsize>\d+)_batchsize_off_(?P<offers>\d+)_(?P<type>lex|nones)"
    )
    container_pattern = r"WordPress7_off_(?P<offers>\d+)\.out"
...
def main():
    ...
    input_directory = "/Users/madalinaerascu/PycharmProjects/SAGE-GNN/Output/SMT-LIB/Wordpress7/"  # Replace with your directory path
